...
namespace CheckerGame.Data
{
    public class Moves
    {
        ...
        public Moves(BoardData board, int currentX, int currentY)
        {
        ...
        private void SimpleMoves()
        {
            int i = currentY;
            int j = currentX;
            if (board[i, j] == BoardData.BoardCodes.DBP || board[i, j] == BoardData.BoardCodes.DWK || board[i, j] == BoardData.BoardCodes.DBK)
            {
                if (i - 1 != -1)
                {
                    if (j - 1 != -1)
                    {
                        if (board[i - 1, j - 1] == BoardData.BoardCodes.D)
            ...
            if (board[i, j] == BoardData.BoardCodes.DWP || board[i, j] == BoardData.BoardCodes.DWK || board[i, j] == BoardData.BoardCodes.DBK)
            {
                if (i + 1 != 8)
                {
                    if (j - 1 != -1)
        ...
        private void AdvancedMoves()
        {
            ...
            #region DBP
            if (board[i, j] == BoardData.BoardCodes.DBP)
            {
                do
                {
                    noNewPath = true;
                    ...
                    if (i - 2 > -1)
                    {
                        if (j - 2 > -1)
                        {
                            if (board[i - 2, j - 2] == BoardData.BoardCodes.D && (board[i - 1, j - 1] == BoardData.BoardCodes.DWK || board[i - 1, j - 1] == BoardData.BoardCodes.DWP))
                            {
            ...
            #endregion DBP
            #region DWK
            if (board[i, j] == BoardData.BoardCodes.DWK)
            {
                do
                {
                    noNewPath = true;
                    ...
                    if (i - 2 > -1)
                    {
                        if (j - 2 > -1)
                        {
                            if (board[i - 2, j - 2] == BoardData.BoardCodes.D && (board[i - 1, j - 1] == BoardData.BoardCodes.DBK || board[i - 1, j - 1] == BoardData.BoardCodes.DBP))
                            {
                                JumpMove jumpMove = new JumpMove();
                                jumpMove.currentPosY = i - 2;
                                jumpMove.currentPosX = j - 2;
            ...
            #endregion DWK
            #region DWP
            if (board[i, j] == BoardData.BoardCodes.DWP)
            {
                do
                {
                    noNewPath = true;
            ...
            #endregion DWP
            #region DBK
            if (board[i, j] == BoardData.BoardCodes.DBK)
            {
                do
                {
                    noNewPath = true;
